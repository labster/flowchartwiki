...
function renderTable() {
    ...
    $output .= "<tr><td colspan='2' style='padding: 2pt; border: 1px solid black;'><strong>".wfMessage('fchw_TypeOfPage')->text()." '".$wgParser->getTitle()->getPrefixedText()."':</strong> ".renderDepType()."</td></tr>";
    $output .= "<tr><td valign='top' style='padding: 2pt; border: 1px solid black;'><strong>".wfMessage('fchw_WhereDoILinkTo')->text()."</strong><br />".renderWhereDoIlink()."</td>";
    $output .= "<td valign='top' style='padding: 2pt; border: 1px solid black;'><strong>".wfMessage('fchw_WhoLinksHere')->text()."</strong><br />".renderWhoLinksHere()."</td></tr>";
    $output .= "</table>";
    return $output;
}
